...
const pages = [
  ...
  {
    path: "pages/book-menu/book-menu",
    style: {
      navigationStyle: "custom"
    }
  },
  ...
  {
    path: "pages/coffee-product-detail/coffee-product-detail",
    style: {
      navigationStyle: "custom"
    }
  },
  {
    path: "pages/book-pay/book-pay",
    style: {
      navigationStyle: "custom"
    }
  },
  {
    path: "pages/shuku/shuku",
    style: {
      navigationStyle: "custom"
    }
  },
...
const S = true, b = "mp-weixin", A = I(define_process_env_UNI_SECURE_NETWORK_CONFIG_default), T = b, C = I('{"address":["127.0.0.1","192.168.3.15"],"servePort":7000,"debugPort":9000,"initialLaunchType":"local","skipFiles":["<node_internals>/**","C:/Users/23604/Downloads/HBuilderX.5.15.2026070915/HBuilderX/plugins/unicloud/**/*.js"]}'), P = I('[{"provider":"aliyun","spaceName":"xin-coffee","spaceId":"mp-3eced8ba-6a2a-43e0-a4d3-5c9de8367250","clientSecret":"mA0in8l3i4Xp+ysG55f/Ew==","endpoint":"https://api.next.bspapp.com","failoverEndpoint":""}]') || [];
let E = "";
try {
  E = "__UNI__A4083EF";
} catch (e2) {
